...
atmosphere.scale.set(1.055, 1.055, 1.055);
...
// Tweaks
gui.add(sunSpherical, 'phi', 0, Math.PI * 2).onChange(updateSun);
gui.add(sunSpherical, 'theta', 0, Math.PI * 2).onChange(updateSun);
